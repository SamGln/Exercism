...
export function fixListOfWagons(ids) {
  const [a, b, ...othersIds] = ids;
  return [...othersIds, a, b];
}
...
export function correctListOfWagons(ids, missingWagons) {
  const [firstId, ...othersId] = ids;
  return [firstId, ...missingWagons, ...othersId];
}
...
export function separateTimeOfArrival(information) {
  const {timeOfArrival, ...othersInformation} = information;
  return [timeOfArrival, othersInformation];
}
